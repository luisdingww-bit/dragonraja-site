...
(function(){
  ...
  window.I18N = {
    zh: {
      ...
      login_hint: "请输入邮箱与密码",
      login_forgot: "忘记密码？",
      login_hint_local: "提示：演示模式下账号仅保存在当前浏览器；密码区分大小写，注意别带多余空格。",
      reset_title: "重 置 密 码",
      reset_back: "← 返回登录",
      reset_hint: "演示模式下账号仅保存在注册时的浏览器：填写注册时使用的邮箱、姓名与年龄，即可重新设置密码。",
      reset_hint_sb: "请输入注册邮箱，我们会向该邮箱发送密码重置链接。",
      reset_email_ph: "注册邮箱 / Email",
      reset_name_ph: "注册姓名 / Registered name",
      reset_age_ph: "注册年龄 / Registered age",
      reset_newpass_ph: "新密码 / New password",
      reset_confirm_ph: "确认新密码 / Confirm new password",
      reset_submit: "重 置 密 码",
      reset_sent: "密码重置链接已发送到你的邮箱，请查收后点击链接设置新密码。",
      reset_done: "密码已重置，请使用新密码登录。",
      reset_notfound: "未找到该邮箱的本地账号。演示模式下账号仅保存在注册时的浏览器中——请回到注册设备登录，或在本浏览器重新登记。",
      reset_mismatch: "姓名或年龄与注册信息不符，无法重置密码。",
      reset_pass_short: "新密码至少需要 6 位",
      reset_confirm_err: "两次输入的新密码不一致",
      recover_h1: "重 置 密 码",
      recover_sub: "设置一个新密码，重新握紧你的档案",
      recover_newpass_ph: "新密码 / New password",
      recover_confirm_ph: "确认新密码 / Confirm new password",
      recover_submit: "设 置 新 密 码",
      recover_done: "密码已更新，正在带你返回学院……",
      recover_nosb: "该功能需要启用 Supabase 云端账号（在 auth.js 中填入项目 URL 与 anon key 后，重置邮件才会生效）。",
      recover_to_home: "← 返回首页",
      acc_welcome: "欢迎，",
      acc_logout: "退出",
      acc_login: "登录",
      ...
      nav_quiz: "学院测验",
      ach_title: "档案完成度",
      ach_sub: "混血种收藏与成就系统 · 纯本地保存",
      quotes_h1: "语 录 图 书 馆",
      quotes_h2: "名 句 · 人 物 · 主 题 · 卷 次",
      quotes_sub: "按人物 / 主题 / 卷次筛选 · 支持搜索与收藏",
      quotes_search_ph: "搜索语录 / 人物…",
      quotes_fav_only: "仅看收藏",
      quotes_to_story: "回到情节长卷",
      rand_to_lib: "前往语录图书馆",
      ach_mini_hint: "完成鉴定与互动即可点亮徽章",
      s07_h2: "档 案 新 馆",
      s07_sub: "语录 · 编年史 · 机构 · 装备 · 测验",
      pv_quotes_t: "名 句 留 声",
      pv_quotes_d: "按人物 / 主题 / 卷次检索经典台词，支持收藏与每日一句。",
      pv_tl_t: "时 间 长 河",
      pv_tl_d: "从黑王诞生到世界树终局，垂直时间轴纵览全史。",
      pv_orgs_t: "机 构 档 案",
      pv_orgs_d: "秘党 / 执行部 / 装备部 / 狮心会 / 学生会 / 蛇岐八家。",
      pv_items_t: "道 具 图 鉴",
      pv_items_d: "黑卡 / 红白护腕 / 迈巴赫 / 七宗罪，一件藏品一段名场面。",
      pv_quiz_t: "混 血 种 考 场",
      pv_quiz_d: "「你是龙族中的谁」人格测试 + 龙族知识快问快答。",
      tl_h1: "龙 族 编 年 史",
      tl_h2: "从 黑 王 诞 生 到 世 界 树 终 局",
      tl_sub: "点击节点，展开时代档案卡 · 与情节长卷联动",
      orgs_h1: "卡 塞 尔 机 构 簿",
      orgs_h2: "一 家 机 构 一 张 档 案 卡",
      orgs_sub: "职能 · 代表人物 · 经典事件 · 经典梗",
      orgs_to_items: "下一站 · 装备部仓库",
      items_h1: "装 备 部 仓 库",
      items_h2: "黑 卡 · 护 腕 · 七 宗 罪 · 尼 伯 龙 根 钥 匙",
      items_sub: "每一件藏品，都对应一段名场面",
      items_to_sins: "七宗罪 · 权与力 独立档案",
      quiz_h1: "学 院 测 验",
      quiz_h2: "你 是 龙 族 中 的 谁 ？",
      quiz_sub: "十道选择题 · 匹配你的混血种原型",
      quiz_tab_person: "人格测试",
      quiz_tab_know: "知识快问快答",
      quiz_next: "下一题 →",
      eva_h1: "EVA · 学 院 终 端",
      eva_kick: "人工智能 · 终端意志",
    ...
    en: {
      ...
      login_hint_local: "Note: in demo mode your account is stored only in this browser; passwords are case-sensitive — mind stray spaces.",
      reset_title: "RESET PASSWORD",
      reset_back: "← Back to login",
      reset_hint: "In demo mode the account is stored only in the registering browser: enter the email, name and age used at registration to set a new password.",
      reset_hint_sb: "Enter your registered email — we will send a password reset link to it.",
      reset_email_ph: "Registered email",
      reset_name_ph: "Registered name",
      reset_age_ph: "Registered age",
      reset_newpass_ph: "New password",
      reset_confirm_ph: "Confirm new password",
      reset_submit: "RESET PASSWORD",
      reset_sent: "A password reset link has been sent to your email. Open it to set a new password.",
      reset_done: "Password reset. Please sign in with your new password.",
      reset_notfound: "No local account with this email. In demo mode the account lives only in the browser where you registered — sign in there, or register again in this browser.",
      reset_mismatch: "Name or age does not match the registration info.",
      reset_pass_short: "New password must be at least 6 characters",
      reset_confirm_err: "The two new passwords do not match",
      recover_h1: "RESET PASSWORD",
      recover_sub: "Set a new password and take back your file",
      recover_newpass_ph: "New password",
      recover_confirm_ph: "Confirm new password",
      recover_submit: "SET NEW PASSWORD",
      recover_done: "Password updated — returning you to the academy…",
      recover_nosb: "This feature requires the Supabase cloud account (paste your project URL and anon key into auth.js; then reset emails will work).",
      recover_to_home: "← Back to home",
      acc_welcome: "Welcome, ",
      acc_logout: "Log out",
      acc_login: "Login",
      ...
      nav_orgs: "Institutions",
      nav_items: "Arsenal",
      nav_quiz: "Quiz",
      ach_title: "FILE PROGRESS",
      ach_sub: "Achievement system · saved locally",
      quotes_h1: "QUOTE LIBRARY",
      quotes_h2: "WORDS · PEOPLE · THEMES · VOLUMES",
      quotes_sub: "Filter by speaker / theme / volume · search & favorite",
      quotes_search_ph: "Search quotes / speaker…",
      quotes_fav_only: "Favorites only",
      quotes_to_story: "Back to the Volumes",
      rand_to_lib: "Open the Quote Library",
      ach_mini_hint: "Complete rituals and interactions to light up badges",
      s07_h2: "NEW WINGS",
      s07_sub: "Quotes · Chronicle · Institutions · Arsenal · Quiz",
      pv_quotes_t: "WORDS IN THE BLOOD",
      pv_quotes_d: "Search classic lines by speaker / theme / volume, with favorites and a daily quote.",
      pv_tl_t: "THE LONG RIVER OF TIME",
      pv_tl_d: "From Nidhogg's birth to the World Tree finale — the whole chronicle on one timeline.",
      pv_orgs_t: "INSTITUTION DOSSIERS",
      pv_orgs_d: "Secret Party · Execution Bureau · Equipment Dept. · Lionheart · Student Union · Snake-Octad.",
      pv_items_t: "THE ARSENAL",
      pv_items_d: "Black Card · wristband · Maybach · Seven Sins — every relic carries a famous scene.",
      pv_quiz_t: "THE EXAM HALL",
      pv_quiz_d: "A 'who are you in Dragon Raja' test plus a quick knowledge quiz.",
      tl_h1: "THE CHRONICLE",
      tl_h2: "FROM NIDHOGG'S BIRTH TO THE WORLD TREE",
      tl_sub: "Click a node to open its era dossier · linked with the Volumes",
      orgs_h1: "CASSEL INSTITUTIONS",
      orgs_h2: "ONE INSTITUTION · ONE DOSSIER",
      orgs_sub: "Function · Key people · Classic events · Memes",
      orgs_to_items: "Next · The Arsenal",
      items_h1: "THE ARSENAL",
      items_h2: "BLACK CARD · BAND · SEVEN SINS · NIBELUNGEN KEY",
      items_sub: "Every relic carries a famous scene",
      items_to_sins: "The Seven Sins · Full Dossier",
      quiz_h1: "EXAMINATION",
      quiz_h2: "WHO ARE YOU IN DRAGON RAJA?",
      quiz_sub: "Ten questions · find your hybrid archetype",
      quiz_tab_person: "Personality",
      quiz_tab_know: "Quick Quiz",
      quiz_next: "Next →",
