...
(function(){
  ...
  window.I18N = {
    zh: {
      ...
      boot_account_btn: "录取登记 / 登录",
      boot_letter_toggle: "录取通知书",
      ...
      acc_logout: "退出",
      acc_login: "登录",
      ritual_needlogin: "请先以学员身份登录，鉴定结果才会记入你的档案",
      eva_profile_title: "学员档案",
      eva_profile_name: "姓名",
      eva_profile_blood: "血统等级",
      eva_profile_spirit: "觉醒言灵",
      eva_profile_notest: "尚未鉴定",
      eva_login_cta: "登录以绑定你的学员档案，让 EVA 记住你的血统与言灵",
      nav_tag: "混血种档案",
      nav_story: "情节长卷",
      nav_codex: "言灵图鉴",
      nav_kings: "四大龙王",
    ...
    en: {
      ...
      boot_account_btn: "REGISTER / LOGIN",
      boot_letter_toggle: "ADMISSION NOTICE",
      ...
      acc_logout: "Log out",
      acc_login: "Login",
      ritual_needlogin: "Log in as a cadet first; your result will then be saved to your file",
      eva_profile_title: "CADET PROFILE",
      eva_profile_name: "Name",
      eva_profile_blood: "Bloodline",
      eva_profile_spirit: "Awakened Spirit",
      eva_profile_notest: "Not tested",
      eva_login_cta: "Log in to bind your cadet profile — let EVA remember your bloodline and spirit",
